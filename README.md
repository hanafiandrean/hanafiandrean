...
**Student at Madora SMK Telkom Sidoarjo (Grade XII – SIJA) with a primary interest in backend development and cybersecurity. An active bug bounty hunter and CTF player, with front-end development skills for building user interfaces.**
...
### 🧰 Stack & Tools
<p>
  <img src="https://skillicons.dev/icons?i=java,python,php,laravel,nodejs,react,mysql,postman,html,css,js,figma,redhat,ubuntu,kali,linux,docker,git&perline=9" />
</p>
